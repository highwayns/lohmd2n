...
====
* knowledgeid: -LdLtaiBADqiIat-6k_45
* author: tei952
* authorid: iHmcxnnRDWPOJAE38On1nCdq0ir2
* language: en
* knowledgetype: 3
* content_count: 39
* introduce: Firebase Study Guildline
...
```
## 5.0 auth.signInWithRedirect(provider)
```
////////////////////////////////////////////////////////////
...
```
## 8.0 signInAndRetrieveDataWithCustomToken(token: string): Promise<UserCredential>
```
...
```
## 9.0 signInAnonymouslyAndRetrieveData(): Promise<UserCredential>
```
...
```
## 15.0 getPriority(): string | number | null
```
...
```
## 39.9 御修了ありがとうございました。
* certificatePath: https://github.com/highwayns/lohmd2n/blob/master/Certificates/firebase.png?raw=true
