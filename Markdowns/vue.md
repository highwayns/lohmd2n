...
* knowledgetype: 10
* content_count: 32
* introduce: VUE高級プログラムデザイン

## 1.0 NextTick 原理分析
```
nextTick 可以让我们在下次 DOM 更新循环结束之后执行延迟回调，用于获得更新后的 DOM。

在 Vue 2.4 之前都是使用的 microtasks，但是 microtasks 的优先级过高，在某些情况下
...
## 2.0 nextTick 同时也支持 Promise 的使用，会判断是否实现了 Promise 
```
js
